...
## Coding Style
This app follows coding style based on [Coding conventions﻿](https://kotlinlang.org/docs/coding-conventions.html/) for source code in the Kotlin Programming Language.
